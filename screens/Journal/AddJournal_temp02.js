...
const AddJournal_temp02 = ({ navigation }) => {
    ...
    const handleSave = async () => {
        if (!image1 && !image2 && !image3 && !coverImg) {
    ...
    const saveJournalWithPrivacy = async (selectedPrivacy) => {
        ...
        try {
            ...
            const image3Url = await uploadImage(image3, `image3-${Date.now()}.jpg`);
            ...
            >
                <ScrollView contentContainerStyle={styles.scrollContainer}>
                    ...
                    <View style={styles.row}>
                        ...
                        <View style={styles.poloroidContainer1}>
                            <TouchableOpacity onPress={() => pickImage(setImage1)} style={styles.imageContainer}>
                                {image1 ? (
                                    ...
                                    <Text style={styles.imagePlaceholder}>Pick Image 1</Text>
                                )}
                            </TouchableOpacity>
                        ...
                        <View style={styles.poloroidContainer2}>
                            <TouchableOpacity onPress={() => pickImage(setImage2)} style={styles.imageContainer}>
                                {image2 ? (
                                    ...
                                    <Text style={styles.imagePlaceholder}>Pick Image 2</Text>
                                )}
                            </TouchableOpacity>
                        ...
                        {/* Second Image Picker */}
                        <View style={styles.poloroidContainer3}>
                            <TouchableOpacity onPress={() => pickImage(setImage3)} style={styles.imageContainer}>
                                {image3 ? (
                                    <Image source={{ uri: image3 }} style={styles.image} />
                                ) : (
                                    <Text style={styles.imagePlaceholder}>Pick Image 3</Text>
                                )}
                            </TouchableOpacity>
                        </View>
                    </View>
...
export default AddJournal_temp02;
